...
// let where_selectFirst=new Map([['clabel','team01'],['cnote1','坏人']]);
// let obj_selectFirst={table_name:'s_config',where_list:where_selectFirst};
// selectFirst(obj_selectFirst).then(function (row) {
//         console.log('查找成功-----------promise');
//         console.log('-----------'+row.clabel+'--------'+row.ccontent);
//     }
// );
// 查询全部记录
